...
<body style="background-color: #F2F2F2;">
	...
	<section class="py-6 style=" position:fixed;float:
		left; width: 15%; height: 702px; margin-top:68px;background-color:#F2F2F2;">
		<div class="container px-4 px-lg-5 mt-5"></div></section>
			...
			<section class="py-6"
				...
				<div class="container px-4 px-lg-5 mt-5">
					...
					<div class="col mb-6">
						<div class="card h-100">
							<a class="btn1 btn-outline-dark mt-auto" href="/receipt">주문
								내역</a>
						</div>
					</div>
					<div class="col mb-7">
    ...
    <g>
      ...
      <rect id="progress-time-fill" x="-100%" y="34"
							clip-path="url(#SVGID_2_)" fill="#BE002A" width="586"
							height="103" />
    </g>

    <g id="death-group">
      <path id="death" fill="#BE002A"
    ...
    <path id="designer-body" fill="#FEFFFE"
    ...
    <circle id="designer-head" fill="#FEFFFE" cx="516.083" cy="53.25"
							r="6.083" />
    ...
    <g id="designer-arm-grop">
      ...
      <path id="designer-pen" fill="#FEFFFE"
				...
				$(document)
						.ready(
								function() {
									...
									$('#progress-time-fill, #death-group')
											.css(
													{
